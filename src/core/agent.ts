...
export class Agent {
  ...
  async step(userInput: string, workspaceOrContext?: string | AgentExecutionContext): Promise<AgentStepResult> {
    return tracer.withSpan(
      ...
      async (rootSpan) => {
        const result = await this.stepInner(userInput, workspaceOrContext);
  ...
  private async stepInner(userInput: string, workspaceOrContext?: string | AgentExecutionContext): Promise<AgentStepResult> {
