...
export const SOFTWARE_FACTORY_CAPABILITY_AUDIT: readonly CapabilityMatrixRow[] = Object.freeze([
  ...
  { service: "software_factory", capability: "read_ci_status", status: "MISSING", risk: "LOW", gap: "MISSING", recommendedAction: "CREATE_SKILL", notes: "githubReadOnlyClient.getCiStatus() existe et est testé — zéro appelant en production (voir skillCatalog.ts)." },
  { service: "software_factory", capability: "read_main_protection", status: "MISSING", risk: "LOW", gap: "MISSING", recommendedAction: "CREATE_SKILL", notes: "githubReadOnlyClient.getMainProtectionStatus() existe et est testé — zéro appelant en production." },
