...
export class WorkspaceStore {
  ...
  /**
   * Résout un chemin workspace vers un chemin absolu vérifié (mêmes règles de
   * sandbox que `target`: pas de "..", pas d'absolu, pas de symlink) sans
   * appliquer `maxFileBytes` — pour les consommateurs (ex. Workbench) qui
   * appliquent leur propre limite de taille explicite avant lecture/streaming.
   */
